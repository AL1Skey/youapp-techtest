    ...
    <div className='h-full translate-y-36'>
      <article className='article p-10 h-full flex flex-col justify-center'>
        ...
        <form action="" method="post" className='mt-5 '>
          <input type="text" name="name" className='bg-gradient-to-r from-[#1c2b31] to-[#233b3f] w-full h-10 my-2 py-3 px-2 rounded-lg text-sm' id="" placeholder='Enter Username/Email' />
